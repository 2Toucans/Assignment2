...
+ (Model*) loadModel: (NSString*)res {
    ...
    model.vertices = malloc(sizeof(float) * finalVertices.count);
    model.normals = malloc(sizeof(float) * finalNormals.count);
    model.texCoords = malloc(sizeof(float) * finalTexCoords.count);
    model.indices = malloc(sizeof(int) * indices.count);
